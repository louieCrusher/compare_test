...
public class UpdateTemporalPropertyTest {
    ...
    public void run() throws Exception {
        ...
        tx.setStartTime((int) (Timestamp.valueOf("2010-05-01 00:07:00").getTime() / 1000L));
        tx.setEndTime((int) (Timestamp.valueOf("2010-05-01 00:08:00").getTime() / 1000L));
        tx.setJamStatus(10);
        tx.setSegmentCount(4);
        tx.setTravelTime(30);
        tx.setRoadId("595640_00049");
